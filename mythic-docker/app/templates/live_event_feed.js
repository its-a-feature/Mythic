    ...
    methods:{
       apply_filter: function(e){
        ...
        entry_color: function(e){
          if(e['level'] === 'warning' && !e['resolved']){return 'background-color:indianred;white-space: nowrap; width:100%';}
          if(e['level'] === 'warning' && e['resolved']){return 'background-color:darkseagreen;white-space: nowrap; width:100%'}
          if(e['operator'] === 'Mythic'){return 'color:cornflowerblue;white-space: nowrap; width:100%';}
