    ...
    methods: {
        modify_button: function(o){
            ...
            for(let i = 0; i < potential_operators.length; i++){
                let mem_add = {"username": potential_operators[i]['username'], "selected": false, "view_mode": "operator"};
                o.members.forEach((x)=>{
		    ...
		    $( '#operationModifySubmit' ).unbind('click').click(function(){
		        ...
		        for( let i = 0; i < operators_vue.operation_members.length; i++){
                    ...
                    if(to_remove){
                        ...
                        add_members.push({"username": operators_vue.operation_members[i]['username'], "view_mode": operators_vue.operation_members[i]['view_mode']});
                    }
                }
        ...
        new_operation_button: function(){
		    ...
		    $( '#operationModifySubmit' ).unbind('click').click(function(){
		        ...
		        for( let i = 0; i < operators_vue.operation_members.length; i++){
		            if(operators_vue.operation_members[i]['selected']){
		                data['members'].push({"username": operators_vue.operation_members[i]['name'], "view_mode": operators_vue.operation_members[i]['view_mode']});
                    }
                }
		        console.log(data);
        ...
        modify_acls_button: function(o){
             ...
             $( '#operationModifyACLsSubmit' ).unbind('click').click(function(){
                ...
                modify_user_acls.members.forEach(function(x){
                    if(x.base_disabled_commands === "None"){x.base_disabled_commands = undefined}
