...
type Payload struct {
	...
	Payloadtype      Payloadtype       `db:"payloadtype" json:"payloadtype"`
	OperationID      int               `db:"operation_id" json:"operation_id"`
	Operation        Operation         `db:"operation" json:"-"`
	WrappedPayloadID structs.NullInt64 `db:"wrapped_payload_id" json:"wrapped_payload_id"`
	...
	TaskID           structs.NullInt64 `db:"task_id" json:"task_id"`
	FileID           structs.NullInt64 `db:"file_id" json:"file_id"`
	Filemeta         Filemeta          `db:"filemeta" json:"filemeta"`
