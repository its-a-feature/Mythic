...
if __name__ == "__main__":
    ...
    #apfell.add_task(start_listening())

    task2 = asyncio.ensure_future(start_listening())
    #task2.add_done_callback(rabbitmq_stopped_callback)
    #loop.create_task(start_listening())
    #new_loop = asyncio.new_event_loop()

    #_thread.start_new_thread( start_listening, (new_loop,) )
