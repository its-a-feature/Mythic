exports.ls = function(task, command, params){
    ...
    if(params === "" || params === undefined){
        ...
        if(path === undefined || path === ""){
            return JSON.stringify({"user_output":"Failed to get current working directory", "completed": true, "status": "error"});
        }
    }
    if(path[0] == '"'){
    ...
    return JSON.stringify({"user_output":"Failed to get attributes of file", "completed": true, "status": "error"});
};
COMMAND_ENDS_HERE