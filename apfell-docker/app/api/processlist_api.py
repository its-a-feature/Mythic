...
@apfell.route(apfell.config['API_BASE'] + "/process_lists/", methods=['GET'])
@inject_user()
...
@apfell.route(apfell.config['API_BASE'] + "/process_list/<pid:int>/<host:string>", methods=['GET'])
@inject_user()
@scoped(['auth:user', 'auth:apitoken_user'], False)  # user or user-level api token are ok
...
@apfell.route(apfell.config['API_BASE'] + "/process_list/search", methods=['POST'])
@inject_user()
@scoped(['auth:user', 'auth:apitoken_user'], False)  # user or user-level api token are ok
