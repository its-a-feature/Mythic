var searches = new Vue({
    ...
    methods:{
        get_page: function(page_num){
            ...
            httpGetAsync("{{http}}://{{links.server_ip}}:{{links.server_port}}{{links.api_base}}/apfell_logs/", get_search_callback, "POST", data);
        },
...
httpGetAsync("{{http}}://{{links.server_ip}}:{{links.server_port}}{{links.api_base}}/apfell_logs", (response) => {
    try{
