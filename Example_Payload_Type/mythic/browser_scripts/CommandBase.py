...
class CommandParameter:
    ...
    def to_json(self):
        return {"name": self._name, "type": self._type.value, "description": self._description, "choices": "\n".join(self._choices),
                "required": self._required, "default_value": self._value}
...
class CommandBase(metaclass=ABCMeta):
    ...
    @property
    @abstractmethod
    def file_browse_parameters(self):
        pass
    ...
    @property
    @abstractmethod
    def download_file_parameters(self):
        pass
    ...
    @property
    @abstractmethod
    def remove_file_parameters(self):
        pass
    ...
    def to_json(self):
        ...
        return {"cmd": self.cmd, "needs_admin": self.needs_admin, "help_cmd": self.help_cmd,
                ...
                "is_file_browse": self.is_file_browse, "file_browse_parameters": self.file_browse_parameters,
                "is_process_list": self.is_process_list, "process_list_parameters": self.process_list_parameters,
                "is_download_file": self.is_download_file, "download_file_parameters": self.download_file_parameters,
                "is_remove_file": self.is_remove_file, "remove_file_parameters": self.remove_file_parameters,
