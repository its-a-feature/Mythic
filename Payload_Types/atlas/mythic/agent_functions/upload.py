...
class UploadArguments(TaskArguments):
    def __init__(self, command_line):
        ...
        self.args = {
            "assembly_id": CommandParameter(name="assembly_id", type=ParameterType.File, description=""),
            "remote_path": CommandParameter(name="remote_path", type=ParameterType.String, description="Take a file from the database and store it on disk through the callback.")
        }
