function(task, responses){
    ...
    if(task.completed){
        try{
            ...
            let output = "<div class='card'><div class='card-header border border-dark shadow'><a class='btn stretched-link' type='button' data-toggle='collapse' data-target='#task" + task['id'] + "screencapture' aria-expanded='false' aria-controls='task" + task['id'] + "screencapture' style='padding:0'>Finished <font color='red'>Screencapture " + escapeHTML(task['params']) + "</font>. Click to view</div>";
