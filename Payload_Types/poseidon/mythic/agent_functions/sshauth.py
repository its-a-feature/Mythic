...
class SSHAuthArguments(TaskArguments):
    def __init__(self, command_line):
        ...
        self.args = {
            "username": CommandParameter(name="username", type=ParameterType.String,
            ...
            "source": CommandParameter(name="source", type=ParameterType.String,
                                       description="If doing SCP, this is the source file", required=False,
                                       default_value=""),
            "destination": CommandParameter(name="destination", type=ParameterType.String,
                                       description="If doing SCP, this is the destination file", required=False,
                                       default_value=""),
            "private_key": CommandParameter(name="private_key", type=ParameterType.String,
                                       description="Authenticate to the designated hosts using this private key", required=False),
            ...
            "command": CommandParameter(name="command", type=ParameterType.String,
