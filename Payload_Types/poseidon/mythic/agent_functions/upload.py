...
class UploadArguments(TaskArguments):
    def __init__(self, command_line):
        ...
        self.args = {
            "remote_path": CommandParameter(name="remote_path", type=ParameterType.String,
                                         description="Remote file path."),
            "file_id": CommandParameter(name="file_id", type=ParameterType.File,
...
class UploadCommand(CommandBase):
    ...
    async def create_tasking(self, task: MythicTask) -> MythicTask:
        ...
        response = await MythicFileRPC(task).register_file(file=task.args.get_arg("file_id"),
