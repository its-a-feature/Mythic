...
export const PayloadBuildMetadataChips = ({buildMetadata}) => {
    const values = [
        buildMetadata?.os,
        buildMetadata?.architecture,
...
export function PayloadsTableRow(props){
    ...
    const onCloseFilenameDisplay = () => {
        setOpenFilenameDialog(false);
        props.onChangeFilename();
    }
        ...
        <React.Fragment>
            <TableRow key={"payload" + props.uuid} hover>
                <MythicStyledTableCell>
                    <MythicActionButton compact tone="info"
                ...
                {openFilename &&
                    <MythicDialog fullWidth={true} maxWidth="md" open={openFilename} 
                        ...
                        innerDialog={<PayloadFilenameDialog payload_id={props.id} onClose={onCloseFilenameDisplay} />}
                    />
                }
                {openBuildMessage &&
