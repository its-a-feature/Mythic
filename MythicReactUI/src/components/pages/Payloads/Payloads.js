...
export function Payloads(props){
    ...
    const onChangeFilename = () => {
        fetchNewPage({variables: {offset: (pageData.currentPage - 1) * pageData.fetchLimit, limit: pageData.fetchLimit, showDeleted: pageData.showDeleted, showAutogenerated: pageData.showAutogenerated}})
