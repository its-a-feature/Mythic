    ...
    return (
        <>
            <MythicPageHeader
                ...
                actions={
                    <>
                        <MythicToolbarButton variant="contained" colorMode="hover" tone="success" startIcon={<AddCircleIcon />} onClick={() => navigate("/new/createpayload")}>
                            Payload
                        </MythicToolbarButton>
                        <MythicToolbarButton variant="outlined" colorMode="hover" tone="success" startIcon={<Inventory2Icon />} onClick={() => navigate("/new/createwrapper")}>
                            Wrapper
                        </MythicToolbarButton>
                        <MythicToolbarButton variant="outlined" colorMode="hover" tone="primary" startIcon={<FileUploadIcon />} onClick={() => setOpenPayloadImport(true)}>
                            Import Config
                        </MythicToolbarButton>
                        <MythicToolbarToggle
                            checked={showDeleted}
