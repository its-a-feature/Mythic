...
export function PayloadsTable({payload, onDeletePayload, onUpdateCallbackAlert, onRestorePayload, me,
                                  ...
                                  onCallbacksAllowedChanged, openBackdrop, onChangeFilename}){
                ...
                actions={
                    <>
                        ...
                        <MythicActionButton
                            colorMode="hover"
                            icon={<Inventory2Icon />}
                            onClick={() => navigate("/new/createwrapper")}>
                            Wrapper
                        </MythicActionButton>
                        <MythicActionButton
                            colorMode="hover"
                            icon={<FileUploadIcon />}
                            onClick={() => setOpenPayloadImport(true)}>
                            Import Config
                        </MythicActionButton>
                        <MythicActionButton
                        ...
                        <MythicActionButton
                            ...
                            label="Autogenerated"
                            icon={showAutogenerated ? <VisibilityIcon fontSize="small" /> : <VisibilityOffIcon fontSize="small" />}
                        />
                    </>
                }
            />
