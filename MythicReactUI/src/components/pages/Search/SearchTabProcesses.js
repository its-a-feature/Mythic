...
query tagProcessQuery($tag: String!, $host: String!, $offset: Int!, $fetchLimit: Int!) {
    tag_aggregate(distinct_on: id, where: {mythictree_id: {_is_null: false}, data: {_cast: {String: {_ilike: $tag}}}, mythictree: {host: {_ilike: $host}, tree_type: {_eq: "process"}}}) {
      aggregate {
        count
      }
    }
    tag(limit: $fetchLimit, distinct_on: id, offset: $offset, order_by: {id: desc}, where: {mythictree_id: {_is_null: false}, data: {_cast: {String: {_ilike: $tag}}}, mythictree: {host: {_ilike: $host}, tree_type: {_eq: "process"}}}) {
      mythictree {
        ...mythictreeData
      }
