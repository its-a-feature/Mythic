                    ...
                    contextMenuOptions.map((option, index) => (
                        option.type === 'item' ? (
                            <DropdownMenuItem
                                ...
                                className={option.className || (option.danger ? "mythic-action-tone-hover mythic-tone-error" : undefined)}
                            ...
                            <DropdownNestedMenuItem
                                ...
                                menu={
                                    ...
                                    <DropdownMenuItem
                                        ...
                                        className={menuOption.className || (menuOption.danger ? "mythic-action-tone-hover mythic-tone-error" : undefined)}
