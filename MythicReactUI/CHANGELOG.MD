...
- Fixed a bug in the process browser that would set a filter to undefined instead of ""
...
- Slight tweak to `tabs` browser script capability to cap the max size of the tabs
- Fixed a scrolling issue on the single task view page
